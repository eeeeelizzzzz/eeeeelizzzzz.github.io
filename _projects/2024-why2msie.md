...
Our operations were based on the WHyMSIE project’s ER2 overflight schedule and flight plan. The Plan of the Day (POD) can accessed via [Github.](acwu1/WHyMSIE_POD). Our team was activated to fly UAS when the ER-2 aircraft flew over our region! 

### Our science role?
_Combined Retrievals (Thermodynamic Profiles)_
...
_Model→Obs and Obs→Model Development_
...
_Radar-based boundary-layer height estimation_
*Methods evaluation and development
*Possible collaboration with new groups and integration of new datasets to this work
...
| Instrument | Description | ER2-based Spatial Scale |
| --- | --- | --- |
| Conical Scanning Millimeter-wave Imaging Radiometer - Hyperspectral (CoSMIR-H) | Vertical profiles of temperature, water vapor and cloud properties | 1 km |
| Microwave Barometric Radar and Sounder (MBARS) | Surface pressure measurements | 1-4 km |
| Cloud Physics Lidar (CPL) | Cloud optical depth, cloud layer boundaries, and PBL height | 300 m |
| Cloud Radar System (CRS) | High-resolution profiles of reflectivity and Doppler velocity in clouds | 125 m |
| Scanning-High-resolution Interferometer Sounder (S-HIS) | Vertical profiles of temperature, water vapor | 3 km |
| National Airborne Sounder Testbed - Interferometer (NAST-I) | Vertical profiles of temperature, water vapor | 2.5 km |
| Advanced Microwave precipitation Radiometer (AMPR) | Cloud, precipitation, water vapor, and surface properties (including ocean winds) | 0.64 km - 2.78 km |
| Enhanced MODIS Airborne Simulator (eMAS) | Cloud properties and surface properties | 30 m |
| High Altitude Lidar Observatory (HALO) | Vertical profiles of water vapor, aerosol and cloud optical properties | 6-12 km x 315 m |
| Aerosol Doppler Wind Lidar (AWP) | Winds from aerosol Doppler shift | |
